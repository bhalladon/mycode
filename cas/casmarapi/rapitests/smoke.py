...
import shutil,ssl,sys
from timeit import itertools
import paramiko
from paramiko import ssh_exception
from paramiko_expect import SSHClientInteraction
import threading
import socket,xmlrunner
...
if os.getenv("HOST_IP"):
    cas_ip=os.getenv("HOST_IP")
else:
    sys.exit("Please define host IP")

if os.getenv("CAS_IP"):
    cas_ip=os.getenv("CAS_IP")
else:
    sys.exit("Please define CA IP")
    
if os.getenv("CAS_ADMIN_USERNAME"):
    cas_adminuser=os.getenv("CAS_ADMIN_USERNAME")
else:
    sys.exit("Please define cas admin user.")

if os.getenv("CAS_ADMIN_PASSWORD"):
    cas_adminpass=os.getenv("CAS_ADMIN_PASSWORD")
else:
    sys.exit("Please define cas admin password.")
