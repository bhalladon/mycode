...
class helpandtroubleshooting(unittest.TestCase):
    ...
    def test_a_helplink(self):
        ...
        help_link = b.find_element_by_link_text("Public API Docs").get_attribute("target")
        if (help_link == "_blank"):
            print "Checkpoint 4: [PASSED] Public API Docs opens up in new page."
        else:
            print "Checkpoint 4: [FAILED] Public API Docs opens up in same window."
            print self.fail("Case Status: FAILED.")
            return 0
