...
class software_updates(unittest.TestCase):
    ...
    def test_A_enable_critical_def_updates(self):
        ...
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        if (critical_updates.is_selected() == True):
            print "Checkpoint 4: [PASSED] Critical updates gets enabled successfully."
        else:
            print "Checkpoint 4: [FAILED] Failed to enable critical updates."
            print self.fail("Case Status: FAILED.")
            return 0
        time.sleep(1)
        ...
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        if (definition_updates.is_selected() == True):
            print "Checkpoint 5: [PASSED] definition updates gets enabled successfully."
        else:
            print "Checkpoint 5: [FAILED] Failed to enable definition updates."
            print self.fail("Case Status: FAILED.")
            return 0    
    ...
    def test_b_set_updatefrequency(self):
        ...
        time.sleep(2) 
        ## Set to 15
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[1]').click()
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        time.sleep(2)
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[1]').get_attribute("value")

        if (update_freq == "15 minutes"):
        ...
        ## Set to 30
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[2]').get_attribute("value")
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        ...
        time.sleep(1) 
        ## Set to 60
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[3]').click()
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        update_freq = b.find_element_by_name("filesize").get_attribute("value")
        if (update_freq == "60"):
        ...
        time.sleep(1)
        ## Set to 120
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[4]').click()
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        update_freq = b.find_element_by_name("filesize").get_attribute("value")
        if (update_freq == "120"):
        ...
        time.sleep(1)
        ## Set to 240
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[5]').click()
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        update_freq = b.find_element_by_name("filesize").get_attribute("value")
        if (update_freq == "240"):
        ...
        time.sleep(1) 
        ## Set to 480
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[6]').click()
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        update_freq = b.find_element_by_name("filesize").get_attribute("value")
        if (update_freq == "480"):
        ...
        time.sleep(1) 
        ## Set to 720
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[7]').click()
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        update_freq = b.find_element_by_name("filesize").get_attribute("value")
        if (update_freq == "720"):
        ...
        time.sleep(1)
        ## Set to 1440
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[8]').click()
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        update_freq = b.find_element_by_name("filesize").get_attribute("value")
        if (update_freq == "1440"):
        ...
        time.sleep(1) 
        ## Set to 2880
        update_freq = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[3]/select/option[9]').click()
        b.find_element_by_xpath('//*[@id="update_configuration"]/div/button').click()
        update_freq = b.find_element_by_name("filesize").get_attribute("value")
        if (update_freq == "2880"):
...
#             print "Checkpoint 8: [PASSED] Update frequency drop down list disabled successfully after enabling USB updates."
    ...
    def test_d_enableproxy(self):
        print "\n>> #### TC3 -  Enable proxy usage."
        do_login(self)
        b=self.driver
        print "\n### First we will verify when proxy usage is not enabled, then all other proxy options should be in disable state."
        time.sleep(2)
        use_proxy_server = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[4]/input')
        if (use_proxy_server.is_selected() == True):
            use_proxy_server.click()
        time.sleep(1)
        proxy_address = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[5]/input')
        ...
        proxy_port = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[6]/input')
        ...
        proxy_authentication = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[7]/input')
        ...
        proxy_username = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[8]/input')
        ...
        proxy_password = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[9]/input')
        ...
        windows_nt_domainname = b.find_element_by_xpath('//*[@id="update_configuration"]/div/span[10]/input')
